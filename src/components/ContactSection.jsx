...
emailjs
      .sendForm(
        "service_7isn0wi",   // replace with your EmailJS service ID
        "template_cjuxf0n",  // replace with your EmailJS template ID
        e.target,
        "f6AeJbGyDdBpOcKX3"       // replace with your EmailJS public key/user ID
      )
      .then(
        (result) => {
          toast({
          ...
          <div data-aos="fade-right" className="space-y-8">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/rohit-singh-361125252/" target="_blank">
                  <Linkedin />
                </a>
  ...
  <div
      data-aos="fade-left"
      className="bg-card p-8 rounded-lg shadow-lg hover:shadow-purple-500/50"
    >
